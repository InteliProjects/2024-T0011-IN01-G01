// criar tela 14 preenchido
class Tela14Preenchido extends Phaser.Scene{
    constructor(){
        super({key: 'Tela14Preenchido'});
    }
    // variáveis
    telaInicial14Preenchido;
    botaoSeguir;
    botaoVoltar;
    // carregar imagens
    preload(){
        this.load.image('tela_inicial14_preenchido', 'assets/cadastro/tela_inicial14_preenchido.png');
    ...
    create () {
        ...
        //adicionar tela
        this.telaInicial14Preenchido = this.add.image(400, 300, 'tela_inicial14_preenchido').setScale(0.57);
