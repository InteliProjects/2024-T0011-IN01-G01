class Tela19quiz1Incorreto extends Phaser.Scene {
    constructor(){ 
        super({key: 'Tela19quiz1Incorreto'});
    }
    
    preload () {
         // Carregamento de assets
        this.load.image ("tela19Incorreto", 'assets/cadastro/respostaErrada19.png');
    ...
    create () {
        ...
        this.add.image (400, 300, "tela19Incorreto").setScale(0.57);
