class Tela22quiz4Incorreto extends Phaser.Scene {
    constructor(){ 
        super({key: 'Tela22quiz4Incorreto'});
    }
    
    preload () {
         // Carregamento de assets
        this.load.image ("tela22Incorreto", 'assets/cadastro/respostaErrada22.png');
    ...
    create () {
        ...
        this.add.image (400, 300, "tela22Incorreto").setScale(0.57);
