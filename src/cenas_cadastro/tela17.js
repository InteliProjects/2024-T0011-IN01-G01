// criacao tela 17
class Tela17 extends Phaser.Scene{
    constructor(){
        super({key: 'Tela17'});
    }
    //variaveis
    ...
    //carregar imagens
    preload(){
        this.load.image('tela_inicial17', 'assets/cadastro/tela_inicial17.png');
    ...
    create () {
        ...
        //adicionar tela
        this.telaInicial17 = this.add.image(400, 300, 'tela_inicial17').setScale(0.57);
