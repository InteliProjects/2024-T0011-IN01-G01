// criacao tela 09
class Tela09 extends Phaser.Scene{
    constructor(){
        super({key: 'Tela09'});
    }
    ...
    //carregar imagens
    preload(){
        this.load.image('tela_inicial9', 'assets/cadastro/tela_inicial9_se_responder_verde.png');
    ...
    create () {
        ...
        //adicionar tela
        this.telaInicial9 = this.add.image(400, 300, 'tela_inicial9').setScale(0.57);
