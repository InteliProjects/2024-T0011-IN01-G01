// criacao da tela 13 opcao 2
class Tela13Op2 extends Phaser.Scene{
    constructor(){
        super({key: 'Tela13Op2'});
    }
    // variáveis
    ...
    // carregar imagens
    preload(){
        this.load.image('tela_inicial13_uni', 'assets/cadastro/tela_inicial13_uni.png');
        ...
        this.load.image('botao_op2_cena13_clicado', 'assets/cadastro/botao_op2_cena13_clicado.png');
    ...
    create () {
        ...
        //adicionar tela
        this.telaInicial13Op2 = this.add.image(400, 300, 'tela_inicial13_uni').setScale(0.57);
        ...
        //adicionar botao op2 clicado
        this.botaoOp2Clicado = this.add.image(400, 315, 'botao_op2_cena13_clicado').setScale(0.15); // botao voltar
        this.botaoOp2Clicado.setDepth(3); 
        this.botaoOp2Clicado.setInteractive();
        //adicionar botao op3
