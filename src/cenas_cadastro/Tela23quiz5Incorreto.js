class Tela23quiz5Incorreto extends Phaser.Scene {
    constructor(){ 
        super({key: 'Tela23quiz5Incorreto'});
    }
    
    preload () {
         // Carregamento de assets
        this.load.image ("tela23Incorreto", 'assets/cadastro/respostaErrada23.png');
    ...
    create () {
        ...
        this.add.image (400, 300, "tela23Incorreto").setScale(0.57);
