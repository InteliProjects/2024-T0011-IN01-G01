class Tela21quiz3Incorreto extends Phaser.Scene {
    constructor(){ 
        super({key: 'Tela21quiz3Incorreto'});
    }
    
    preload () {
         // Carregamento de assets
        this.load.image ("tela21Incorreto", 'assets/cadastro/respostaErrada21.png');
    ...
    create () {
        ...
        this.add.image (400, 300, "tela21Incorreto").setScale(0.57);
