// criar cena 18
class Tela20quiz2 extends Phaser.Scene{
    constructor(){
        super({key: 'Tela20quiz2'});
    }
    ...
    // carregar imagens
    preload(){
        this.load.image('tela_inicial20', 'assets/cadastro/tela_inicial20.png');
    ...
    create () {
        ...
        //adicionar tela
        this.telaInicial20 = this.add.image(400, 300, 'tela_inicial20').setScale(0.57);
        ...
        //ações quando clica no botão falso
        ...
        this.botaoFalso.on('pointerdown', () => {
            ...
            this.scene.start('Tela20quiz2Correto');
        });
        ...
        this.botaoVerdadeiro.on('pointerdown', () => {
            ...
            this.scene.start('Tela20quiz2Incorreto');
        });
